 ...
 * [nago.yml](nago.yml)
     * Determines how your purl.obolibrary.org/obo/nago/ redirects will be handled
     ...
     * Paste in the contents of [nago.yml](nago.yml)
 ...
 * [nago.md](nago.md)
     ...
     * Paste in the contents of [nago.md](nago.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
