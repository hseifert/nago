These notes are for the EDITORS of nago
...
Make sure you have an ID range in the [idranges file](nago-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [nago-edit.owl](nago-edit.owl)

** DO NOT EDIT nago.obo OR nago.owl in the top level directory **

[../../nago.owl](../../nago.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/hseifert/nago) for details.
 ...
 * [nago-idranges.owl](nago-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/nago_terms.txt file
...
Note: the nago_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as nago.owl and nago.obo and places
 ...
 * https://github.com/hseifert/nago/releases
 * https://github.com/hseifert/nago/releases/new
...
what is in the `owl:versionIRI` of the derived nago.owl (`data-version` in
nago.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/nago.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/nago/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/hseifert/nago.svg?branch=master)](https://travis-ci.org/hseifert/nago)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/hseifert](https://travis-ci.org/profile/hseifert)
 2. click the "Sync account" button
 3. Click the tick symbol next to nago
